...
nbi_hampshire |>
  ...
  theme_minimal()
##TA Feedback: Try writing "jitter" in the position part of the geom_point function instead of identity, this moves the points randomly laterally so that closely clustered data can be seen more clearly +2.5
##Correct geom point function: geom_point(size = 2, alpha = 0.5, position = "jitter")
...
##TA Feedback: I appreciate how customized this graph is, it makes it much easier to read! +3
...
##TA Feedback: Great job on this graph! +3
...
##TA Feedback: This graph looks perfect! +3
...
##TA Feedback: This graph looks nice! +3
##Total for Q1-Q10: 29.5
```
