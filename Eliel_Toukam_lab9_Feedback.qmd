...
la_map |>
  addCircleMarkers(data = tri_la_2023,
                   ...
                   fillColor = "white",
                   fillOpacity = 2) 
##TA Feedback: This looks beautiful! +4
...
pal_fact <- colorFactor(palette = "Set2",
                        ...
                        reverse = T)
##TA Feedback: This looks good just remember to use unique next time like this: pal_fact <- colorFactor(palette = "Set2",
...
la_map |>
  ...
  addLegend(data= tri_la_2023,
            pal= colorBin(palette="YlOrRd", 
                    ...
                    n = 6),
            values= ~X107..TOTAL.RELEASES)
##TA Feedback: These look fabolous! +3
...
##TA Feedback: Which one represents the distribution best??
##Total for Q1-Q10: 26 pts
:::
