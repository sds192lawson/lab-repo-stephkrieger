...
##TA feedback: This looks beautiful but try using unique like this next time: pal_fact <- colorFactor(palette = "Set2",
                        #domain = unique(tri_la_2023$X23..INDUSTRY.SECTOR)) +2.5 
##Total for Q1-Q6: 15.5 pts
```
...
##TA feedback: This looks wonderful! +3
...
pal_quant <- colorQuantile(palette = "YlOrRd",
                    domain = tri_la_2023$X107..TOTAL.RELEASES,
                    n = 4)
##TA feedback: These look terrific! +3
##Total for Q1-Q8: 21.5 pts
```
...
addLegend(data = tri_la_2023,
          title = "TRI Releases in Pounds",
            pal = pal_quant, 
            values = ~X107..TOTAL.RELEASES)
##TA Feedback: These look wondrous! +3
##Total for Q1-Q9: 24.5 pts
```
...
##TA Feedback: Amazing answer! +3
##Total for Q1-Q10: 27.5 pts
...
addLegend(data = tri_la_2023,
          title = "TRI Releases in Pounds",
            pal = pal_quant, 
            values = ~X107..TOTAL.RELEASES)
##TA Feedback: This look marvelous! +3
##Total for Q1-Q11: 30.5 pts
```
...
##TA Grading: Final Score: 30.5/30 or 101%
