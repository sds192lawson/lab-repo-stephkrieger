...
hmda_ms_2024 |>
  ...
  theme_minimal() +
  coord_flip()
##TA Feedback: This graph looks good except for one small thing, the y variable is the count of applications not the count of applicants -0.5 for mislabeling
...
hmda_ms_2024  |> 
  ...
  theme_minimal()
##TA feedback: This graph looks great except for one small labeling thing, your y variable is the number of applications not the actual number of granted loans. -0.5 for minor mislabeling
##Total for Q1-Q3: 6.5 pts 
```
...
hmda_ms_2024 |>
  ...
  theme_minimal()
##TA Feedback: I would take another look at the column descriptions in the documentation for this data set. Your Y label is once incorrect, as the Y label is again the count of applications not of actual loans granted to people. -0.5 for mislabeling. 
##Total for Q1-Q4: 8.5 pts
```
...
##TA Feedback: This graph looks amazing! +2 for plot and labels, -0.5 for no description
##Total for Q1-Q5: 10.5 pts
```
...
ggplot(aes(x = derived_race, fill = action_taken))+
  ...
  theme(legend.position = "bottom",
        ...
        legend.key.size = unit(0.4, "cm")) +
  guides(fill=guide_legend(nrow=4))
##TA feedback: This graph looks fantastic! Remember to try to put your + signs at the end of the line. +2.5 pts
...
hmda_ms_2024 |>
  ...
  labs(title = "Home Mortgage Disclosure Act Applications,\n Mississippi, 2024",
       ...
       caption = str_wrap("These boxplots display the loan amounts requested of different applicants races in the state of Mississippi in 2024. The graph shows that asian applicants have a median loan amount higher than applicants of other races, and that black/african american applicants have the most amount of outliers. This could suggest that loan amounts have something to do with the race of the person applying.", 120)) +
  theme_minimal() 
##TA Feedback: This graph looks phenomenal! +2.5
##Total for Q1-Q7: 15.5 pts
...
hmda_denial_by_race |>
  ...
  theme_minimal() +
  coord_flip()
##TA Feedback: This graph looks fabulous! +2.5
##Total for Q1-Q8: 18 pts
```
...
hmda_denial_by_race_sex |>
  ...
  theme_minimal() +
  coord_flip()
##TA Feedback: This graph looks nice! +2.5 
##Total for Q1-Q9: 20.5 pts
```
...
hmda_ms_2024 |>
  ...
  theme(legend.position = "bottom",
        ...
        legend.key.size = unit(0.4, "cm")) +
  guides(fill=guide_legend(nrow=4))
##TA Feedback: This graph looks perfect! +2.5
...
##TA Feedback: This graph looks marvelous! +2.5
##Total for Q1-Q11: 25.5 pts
```
